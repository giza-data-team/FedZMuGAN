...
class ExperimentRunner:
    ...
    def update_env_file(self, lr_unlearn, batch_size_unlearn, samples_per_class):
        ...
        try:
            ...
            logger.info(
                f"Updated values: LR_UNLEARN={lr_unlearn}, BATCH_SIZE_UNLEARN={batch_size_unlearn}, SAMPLES_PER_CLASS={samples_per_class}"
            )
    ...
    def run_experiment(self, lr_unlearn, batch_size_unlearn, samples_per_class):
        ...
        logger.info(
            f"Running experiment with LR_UNLEARN={lr_unlearn}, "
